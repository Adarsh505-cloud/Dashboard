      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-3xl max-h-[90vh] flex flex-col">
        <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Connect a New AWS Account</h2>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-8">
          <div className="space-y-6">
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-semibold text-lg text-gray-800 dark:text-gray-200">Download the Template</h3>
                <p className="text-gray-600 dark:text-gray-400">Download our CloudFormation template. This creates a secure, read-only IAM role that allows our dashboard to analyze your cost data.</p>
                <a
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-semibold text-lg text-gray-800 dark:text-gray-200">Deploy in Your AWS Account</h3>
                ...
                <div className="mt-3 bg-gray-50 dark:bg-gray-900 p-4 rounded-lg border dark:border-gray-700">
                  <div className="flex items-center gap-2 bg-white dark:bg-gray-800 p-2 rounded-md border dark:border-gray-700">
                    <code className="text-sm text-gray-800 dark:text-gray-200">{webAppAccountId}</code>
                    <button onClick={handleCopy} className="ml-auto p-1.5 rounded text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-semibold text-lg text-gray-800 dark:text-gray-200">Enter Role ARN & Account Details</h3>
                <p className="text-gray-600 dark:text-gray-400">Once created, go to "Outputs", copy the `RoleArn`, and paste it below.</p>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5 pt-4 border-t">
            ...
            <div className="p-4 border dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-900">
              <label className="block text-sm font-semibold text-gray-800 dark:text-gray-200 mb-3">Account Type</label>
              <div className="flex gap-6">
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <span className="text-sm font-medium text-gray-800 dark:text-gray-200">Standalone Account</span>
                </label>
                <label className="flex items-center gap-2 cursor-pointer">
                  <input 
                    type="radio" 
                    ...
                    className="w-4 h-4 text-blue-600 focus:ring-blue-500" 
                  />
                  <span className="text-sm font-medium text-gray-800 dark:text-gray-200">Master Payer Account</span>
                </label>
              </div>
            </div>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Your AWS Account ID</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Pasted Role ARN</label>
              <input
                type="text"
